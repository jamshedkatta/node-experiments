...
// configure a lot of plugins here.
server.use(restify.queryParser());
server.use(restify.bodyParser());
server.use(restify.CORS());
// connect to mongo

var connection_string = '127.0.0.1:27017/linkwok_alpha';
var db = mongojs(connection_string, ['linkwok_alpha']);
var jobs = db.collection("test"); 

// Define all the above callback functions
